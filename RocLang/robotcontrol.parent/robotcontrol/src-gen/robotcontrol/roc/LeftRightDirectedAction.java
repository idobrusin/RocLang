 ...
 * </p>
 * <ul>
 *   <li>{@link robotcontrol.roc.LeftRightDirectedAction#getTiltHead <em>Tilt Head</em>}</li>
 * </ul>
 *
 * @see robotcontrol.roc.RocPackage#getLeftRightDirectedAction()
 * @model
 * @generated
 */
public interface LeftRightDirectedAction extends EObject
{
   ...
   * @see robotcontrol.roc.RocPackage#getLeftRightDirectedAction_TiltHead()
   * @model
   * @generated
   */
  String getTiltHead();
  ...
  /**
   * Sets the value of the '{@link robotcontrol.roc.LeftRightDirectedAction#getTiltHead <em>Tilt Head</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
