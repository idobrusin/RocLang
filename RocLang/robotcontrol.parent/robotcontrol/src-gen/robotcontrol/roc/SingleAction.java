 ...
 * </p>
 * <ul>
 *   <li>{@link robotcontrol.roc.SingleAction#getActionName <em>Action Name</em>}</li>
 * </ul>
 *
 * @see robotcontrol.roc.RocPackage#getSingleAction()
 * @model
 * @generated
 */
public interface SingleAction extends EObject
{
   ...
   * @see robotcontrol.roc.RocPackage#getSingleAction_ActionName()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link robotcontrol.roc.SingleAction#getActionName <em>Action Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
