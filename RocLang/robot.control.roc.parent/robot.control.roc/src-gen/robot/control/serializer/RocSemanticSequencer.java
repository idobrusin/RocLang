...
public class RocSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == RocPackage.eINSTANCE)
			...
			case RocPackage.ACTION:
				sequence_Action(context, (robot.control.roc.Action) semanticObject); 
				return; 
	 ...
	 */
	protected void sequence_Action(ISerializationContext context, robot.control.roc.Action semanticObject) {
