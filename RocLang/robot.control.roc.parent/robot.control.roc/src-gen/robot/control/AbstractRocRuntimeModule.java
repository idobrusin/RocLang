...
import robot.control.generator.RocGenerator;
import robot.control.parser.antlr.RocAntlrTokenFileProvider;
import robot.control.parser.antlr.RocParser;
import robot.control.parser.antlr.internal.InternalRocLexer;
import robot.control.scoping.RocScopeProvider;
import robot.control.serializer.RocSemanticSequencer;
import robot.control.serializer.RocSyntacticSequencer;
import robot.control.services.RocGrammarAccess;
import robot.control.validation.RocValidator;
...
public abstract class AbstractRocRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "robot/control/Roc.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("robot.control.Roc");
	}
